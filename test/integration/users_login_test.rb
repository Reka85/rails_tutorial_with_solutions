...
class UsersLoginTest < ActionDispatch::IntegrationTest
  ...
  test "invalid login information" do
    ...
    assert_equal 'Invalid email/password combination', flash[:danger] # 4. verify that new session form gets re-rendered & flash appears
  ...
  test 'login with valid information' do
    ...
    delete logout_path#simulate a user clicking on logout in a second browser window
    follow_redirect!
    assert_template "/"
